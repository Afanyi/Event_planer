...
describe('Filters (unit)', () => {
    ...
    it('renders all fields with controlled values and the Apply button', () => {
        ...
        // Inputs present
        const qInput = screen.getByPlaceholderText('Search title…') as HTMLInputElement;
        ...
        const participantInput = screen.getByPlaceholderText('Participant…') as HTMLInputElement;
