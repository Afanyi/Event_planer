...
describe('EventForm (unit)', () => {
    ...
    it('submits with all fields, tags, participants, and location, calls api and resets form', async () => {
        ...
        const houseInput = form.querySelector('input[name="houseNumber"]') as HTMLInputElement;
        const plzInput = form.querySelector('input[name="postalCode"]') as HTMLInputElement;
